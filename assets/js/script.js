...
if (testimonialsItem.length > 0) {
  for (let i = 0; i < testimonialsItem.length; i++) {
    testimonialsItem[i].addEventListener("click", function () {
      ...
      if (modalImg && avatarImg) modalImg.src = avatarImg.src;
      if (modalTitle && titleElem) modalTitle.innerHTML = titleElem.innerHTML;
      if (modalText && textElem) modalText.innerHTML = textElem.innerHTML;
...
// PAGE NAVIGATION - Fixed version for About, Resume, Contact only
